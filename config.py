...
class Config(object):
    ...
    CLIENT_SECRET = "fg88Q~2xyQs.qhHJsw0OFCCo518BEht6~c62_cmE"
    ...
    CLIENT_ID = "218305b9-ca1e-4239-8473-219833bdf2ff"

    REDIRECT_PATH = "https://lamisonudacitycms-bvb0fthmdccgc9ag.canadacentral-01.azurewebsites.net/getAToken"  # Used to form an absolute URL; must match to app's redirect_uri set in AAD
